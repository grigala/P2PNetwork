...
/**
 * This class represents a peer within the network.
 * The peer class is rather stupid (just for data storage).
 * Network logic shall be implemented in a subclass of Network.
 *
...
public abstract class PeerNode {
     ...
     *
     * @param originOfQuery the node calling the method (purely for logging purposes). Null if it's the client (i.e.,
    ...
    /**
     * Gets the chord predecessor. This method only makes sense for Chord implementations, others should return null
     * (not overriding this).
     *
    ...
    /**
     * Dump chord finger table. This method only makes sense for Chord implementations, others should return null (not
     * overriding this).
     *
